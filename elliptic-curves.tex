...
\begin{itemize}
    ...
    \item Note that ``Different points $P$ give different fields
        ...
        \begin{equation*}
            E(K)/2E(K) \to \{\text{fields $K(\frac{1}{2}P)$}\}
        \end{equation*}
...
\begin{proof}
    ...
    is an elilptic curve over $\F_\p$, and
    \begin{equation*}
        \overline E(\F_\p)[2]
...
\begin{proof}
    ...
    \begin{align*}
        \sigma_1(Q_1) &= Q_1\oplus T & \sigma_1(Q_2) &= Q_2\oplus T \\
        \sigma_2(Q_1) &= Q_1\oplus T' & \sigma_2(Q_2) &= Q_2\oplus T'
    \end{align*}
...
\begin{theorem}[Mordell--Weil Theorem]
    Let $E/K$ be an elliptic curve over an umber field. Then $E(K)$ is
    finitely generated.
\end{theorem}
