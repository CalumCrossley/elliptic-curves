...
\begin{example}
    ...
    \begin{enumerate}[label=\arabic*)]
        ...
        \item If $x_0=2a^2$ $x_0-1=b^2$ $x_0+1=2c^2$, $a=9/z$ then
            $2a^2-z^2=(bz)^2$ and $2a^2+z^2=2(cz)^2$. Hence $az,bz,cz$ are
            integers, and $(a,z)=1$. We see $a$ can't be even as $-1$
            isn't a square mod 8, and $a$ can't be odd as 3 isn't twice a square
            mod 8. % TODO: detail
